                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        <button 
                            ...
                            className="w-full bg-[var(--color-accent)] hover:bg-[var(--color-accent-dark)] text-white font-black py-5 rounded-2xl shadow-xl shadow-[var(--color-accent)]/20 transition-all active:scale-95 disabled:opacity-30 text-lg uppercase tracking-widest"
                        >
                ...
                <div className="animate-in slide-in-from-bottom-8 fade-in duration-1000 space-y-6">
                    ...
                    <div className="glass-card rounded-[2.5rem] p-8 md:p-12 shadow-inner border border-white/5 relative bg-white/[0.01]">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] pointer-events-none select-none">
                            <img src={LOGO_IMAGE_URL} className="w-[500px]" alt="Watermark" />
                        </div>
                    </div>
                </div>
            )}
